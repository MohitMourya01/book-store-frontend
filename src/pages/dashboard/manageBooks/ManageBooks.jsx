...
import { useDeleteBookMutation, useFetchAllBooksQuery } from '../../../Store/features/books/booksApi.js';
...
const ManageBooks = () => {
  ...
  return (
    ...
    <div className="w-full sm:w-11/12 xl:w-8/12 xl:mx-auto mb-12 xl:mb-0 px-4 mt-24">
