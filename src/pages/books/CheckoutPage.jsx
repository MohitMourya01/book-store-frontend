...
import { useCreateOrderMutation } from '../../Store/features/orders/ordersApi.js'
import { useNavigate } from 'react-router-dom'
const CheckoutPage = () => {
    //const currentUser = true ; //Todo : user auth
                            ...
                            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                ...
                                <div className="md:col-span-5 mt-3">
                                    <div className="inline-flex items-center">
                                        <input 
                                        type="checkbox" onChange={(e) => setIsChecked(e.target.checked)} name="billing_same" id="billing_same" className="form-checkbox" />
                                ...
                                <div className="md:col-span-5 text-right">
                                    <div className="inline-flex items-end">
                                        {cartItems.lenth>0 && <button 
                                        disabled={!isChecked}
                                        // onSubmit={handleSubmit}
                                        className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 cursor-pointer rounded">Place an Order</button>} 
                                        <button 
                                        disabled={!isChecked}
                                        // onSubmit={handleSubmit}
                                        className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 cursor-pointer rounded">Place an Order</button>
