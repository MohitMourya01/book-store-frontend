            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className='mb-4'>
                    ...
                    <input 
                     ...
                     type="text" name='username' id='username' className='shadow bg-gray-100 rounded appearance-none focus:outline-none  w-full py-2 px-3 leading-tight focus:shadow ' placeholder='Enter Username'/>
                </div>
                <div className='my-4'>
